...
class Trainer:
    ...
    def __init__(self, model,val_steps=5000,print_steps=5000,output_folder="trainer/"):
        ...
        self.scheduler = ReduceLROnPlateau(self.optimizer, mode='min', factor=0.999999, patience=1000, threshold=1e-3, threshold_mode='rel', cooldown=0, min_lr=1e-5, eps=1e-08)
        try:
